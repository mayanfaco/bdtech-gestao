...
export default function ClienteDetail() {
  ...
  async function handleDelete() {
    if (!window.confirm(`Excluir o cliente "${client.nome}"? Propostas, contratos e outros registros vinculados a ele continuam existindo, mas ele deixa de aparecer nas listas.`)) return;
    setDeleting(true);
  ...
  return (
    <div className="bd-u-flex-col bd-u-gap-6">
      <div>
        <BackButton to="/clientes" label="Voltar para Clientes" />
      </div>
      <div className="bd-u-flex bd-u-items-center bd-u-justify-between">
        ...
        <div className="bd-u-flex bd-u-gap-3">
          ...
          <Button variant="ghost" onClick={handleDelete} loading={deleting} style={{ color: 'var(--bd-danger-500)' }}>Excluir</Button>
        </div>
      </div>
